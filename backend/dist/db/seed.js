...
async function seed() {
    try {
        ...
        await index_1.db.testimonial.deleteMany();
        await index_1.db.comment.deleteMany();
        await index_1.db.projectFile.deleteMany();
        await index_1.db.projectVideo.deleteMany();
        await index_1.db.projectImage.deleteMany();
        await index_1.db.projectTool.deleteMany();
        await index_1.db.serviceExample.deleteMany();
        await index_1.db.project.deleteMany();
        await index_1.db.projectCategory.deleteMany();
        await index_1.db.service.deleteMany();
        await index_1.db.award.deleteMany();
        await index_1.db.education.deleteMany();
        await index_1.db.experience.deleteMany();
        await index_1.db.certification.deleteMany();
        await index_1.db.skill.deleteMany();
        await index_1.db.user.deleteMany();
        await index_1.db.settings.deleteMany();
        // Create admin user
        console.log("Creating admin user...");
        const hashedPassword = await bcrypt_1.default.hash(process.env.ADMIN_PASSWORD || "Admin@123456", 10);
        ...
        await index_1.db.settings.create({
            data: {
        ...
        const categories = await Promise.all([
            index_1.db.projectCategory.create({
                data: {
                    name: "Residential",
                    slug: "residential",
        ...
        for (const project of sampleProjects) {
            await index_1.db.project.create({
                data: project,
            });
        }
        // Create awards
        ...
        await Promise.all([
            index_1.db.certification.create({
                data: {
